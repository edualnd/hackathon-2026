    ...
    <div class="min-h-screen flex items-center justify-center p-8 bg-slate-100">
        ...
        <div class="w-full max-w-7xl h-[720px] rounded-3xl overflow-hidden shadow-2xl flex">
            ...
            <div
                ...
                <div class="absolute bottom-0 right-0 w-72 h-72 rounded-tl-[120px] bg-white/10"></div>
                ...
                <div class="relative z-10 flex flex-col justify-center px-20 text-white">
                    ...
                    <p class="text-xl max-w-lg text-white/90 leading-relaxed">
                        Acesse o painel administrativo da Secretaria Municipal de Educação
                        e gerencie todas as informações do sistema com segurança.
                    </p>
            ...
            <div class="w-full lg:w-1/3 bg-white flex items-center justify-center px-12">
                ...
                <div class="w-full max-w-sm">
                    ...
                    <form method="POST" action="{{ route('login') }}">
                        ...
                        <x-button
                            class="w-full justify-center rounded-xl py-3 text-base">
