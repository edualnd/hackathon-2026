<x-action-section>
    ...
    <x-slot name="content">
        <div class="max-w-xl text-sm text-gray-600 dark:text-gray-400">
            {{ __('Se necessário, você pode encerrar todas as outras sessões do navegador em todos os seus dispositivos. Algumas das suas sessões recentes estão listadas abaixo; no entanto, essa lista pode não estar completa. Se você suspeitar que sua conta foi comprometida, também deve atualizar sua senha.') }}
        </div>
