    ...
    <div class="grid lg:grid-cols-6 gap-4">
        <div class="rounded-3xl bg-lime-200 p-4 flex flex-col justify-center">
            <div class="flex gap-2 items-center">
                ...
                <p class="text-[14px]">Total de vagas</p>
            </div>

            <strong class="text-[2.25rem]/[1.5] font-bold"> {{ $qtdVagas }} </strong>
        </div>
        ...
        <div class="rounded-3xl bg-teal-light-200 p-4 flex flex-col justify-center">
            <div class="flex gap-2 items-center">
                ...
                <p class="text-[14px]">Vagas disponíveis</p>
            </div>

            <strong class="text-[2.25rem]/[1.5] font-bold"> 20 </strong>
        </div>
        ...
        <div class="rounded-3xl bg-teal-dark-200 p-4 flex flex-col justify-center">
            <div class="flex gap-2 items-center">
                ...
                <p class="text-[14px]">Vagas ocupadas</p>
            </div>
        ...
        <div class="rounded-3xl bg-amber-200 p-4 flex flex-col justify-center">
            <div class="flex gap-2 items-center">
                ...
                <p class="text-[14px]">Lista de Espera</p>
            </div>

            <strong class="text-[2.25rem]/[1.5] font-bold"> {{ $qtdEspera }} </strong>
        </div>
    </div>
