<div class="flex justify-center items-center p-8">
   <div class=" p-5 mt-6 overflow-hidden rounded-2xl border border-seduc-neutral-200 bg-background-surface">
   <div class="mb-8 flex flex-wrap items-start justify-between gap-4">
        <div>
            <p class="font-body text-[11px] font-semibold uppercase tracking-wide text-seduc-neutral-500">
            ...
            <p class="mt-2 font-body text-sm text-seduc-neutral-600">
                Consulte a classificação dos estudantes para esta vaga.
            </p>
        </div>
    ...
    <div class="mb-6 rounded-2xl border border-seduc-neutral-200 bg-background-surface p-6">
        <div class="grid gap-6 sm:grid-cols-3">
            ...
            <div>
                <p class="font-body text-xs uppercase tracking-wide text-seduc-neutral-500">
                    Escola
                </p>
                ...
                @empty
                    <tr>
                        <td colspan="3" class="px-5 py-12 text-center">
                            <p class="font-heading text-base font-semibold text-text-on-surface">
