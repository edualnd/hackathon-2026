<div>
    <div class="mx-auto sm:my-8 max-w-7xl px-4 sm:my-12 sm:px-6 lg:px-8">
        ...
        ========================================== --}}
                ...
                ========================================== --}}
                        ...
                        >
                            ...
                            >
                                <div class="mb-3 flex items-center justify-between sm:mb-6">
                                    <div class="flex items-center gap-2">
                                        ...
                                        <h2
                                            class="text-sm font-bold text-yellow-lime-500 sm:text-xl"
                                        >
                                            Filtrar vagas
                                        </h2>
                                    </div>
                            ...
                            <div class="rounded-xl p-2 hidden sm:block">
                                <div class="flex flex-wrap gap-3">
                                    <div
                                        class="flex items-center gap-2 rounded-full bg-gray-50 px-3 py-2"
                                    >
                                        <span class="h-3 w-3 rounded-full bg-red-500"></span>
                                        <span class="text-sm text-gray-700"> Até 19 vagas </span>
                                    </div>
        ...
        <div class="rounded-xl p-2 lg:hidden">
            <div class="flex flex-wrap gap-3">
                <div class="flex items-center gap-2 rounded-full bg-gray-50 px-2 py-1">
                    <span class="h-3 w-3 rounded-full bg-red-500"></span>
                    <span class="text-[12px] text-gray-700"> Até 19 vagas </span>
                </div>

                <div class="flex items-center gap-2 rounded-full bg-gray-50 px-2 py-1">
                    <span class="h-3 w-3 rounded-full bg-yellow-400"></span>
                    <span class="text-[12px] text-gray-700"> De 20 a 30 vagas </span>
                </div>

                <div class="flex items-center gap-2 rounded-full bg-gray-50 px-2 py-1">
                    <span class="h-3 w-3 rounded-full bg-green-500"></span>
                    <span class="text-[12px] text-gray-700"> 31 vagas ou mais </span>
                </div>
            </div>
        </div>
