                        ...
                        @if ($index == 0)
                            ...
                            <ul class="divide-y divide-seduc-neutral-200">
                                @foreach ($item['content'] as $vaga)
                                    <li
                                        class="flex justify-between py-2 hover:cursor-pointer bg-seduc-neutral-100 hover:bg-seduc-neutral-200 py-2 px-3.5 rounded-full mb-2"
