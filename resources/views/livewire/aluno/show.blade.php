                        ...
                        <tr wire:key="aluno-{{ $aluno->id }}" class="hover:bg-seduc-neutral-100/40">
                            ...
                            <td class="px-5 py-4">
                                <div class="flex justify-end gap-2">
                                    <a href="{{ route('alunos.edit', $aluno) }}" class="flex size-8 items-center justify-center rounded-lg border border-seduc-neutral-200 text-seduc-neutral-600 hover:border-teal-dark-400 hover:text-teal-dark-600" title="Editar">
