<div class="mx-auto max-w-7xl px-6 py-8 sm:px-10">
    <div class="mb-6">
        ...
        <h1 class="font-heading text-2xl font-bold text-text-on-surface">
    ...
    <div class="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
        <div class="rounded-2xl border border-seduc-neutral-200 bg-background-surface p-5">
            <div class="flex items-center gap-3">
                <span
                    class="flex size-11 items-center justify-center rounded-full bg-lime-100 text-lime-700"
                >
        ...
        <div class="rounded-2xl border border-seduc-neutral-200 bg-background-surface p-5">
            <div class="flex items-center gap-3">
                <span
                    class="flex size-11 items-center justify-center rounded-full bg-amber-100 text-amber-700"
                >
        ...
        <div class="rounded-2xl border border-seduc-neutral-200 bg-background-surface p-5">
            <div class="flex items-center gap-3">
                <span
                    class="flex size-11 items-center justify-center rounded-full bg-feedback-info text-text-on-info"
                >
    ...
    <div class="mt-8 rounded-2xl border border-seduc-neutral-200 bg-background-surface">
        <div class="flex items-center justify-between border-b border-seduc-neutral-200 px-6 py-4">
            ...
            <a
                ...
                class="font-body text-sm font-semibold text-teal-dark-600 hover:text-teal-dark-700"
                >Ver todos →</a
            >
        </div>
            ...
            <table class="w-full text-left">
                <thead>
                    <tr class="border-b border-seduc-neutral-200">
                        <th
                            class="px-6 py-3 font-body text-[11px] font-semibold uppercase tracking-wide text-seduc-neutral-600"
                        >
                            Nome
                        </th>
                        <th
                ...
                <tbody class="divide-y divide-seduc-neutral-100">
                    @forelse ($recentes as $aluno)
                        <tr>
                            <td
                                class="px-6 py-3.5 font-body text-sm font-medium text-text-on-surface"
                            >
                                {{ $aluno['aluno']['nome'] }}
                            </td>
                            <td class="px-6 py-3.5 font-body text-sm text-seduc-neutral-600">
                                {{ $aluno['aluno']['escola']['nome']?? '—' }}
                            </td>
                            <td class="px-6 py-3.5 font-body text-sm text-seduc-neutral-600">
                                {{ $aluno['vaga']['serie'] ?? '—' }}
                            </td>
                    ...
                    @empty
                        <tr>
                            <td
                                colspan="4"
                                class="px-6 py-8 text-center font-body text-sm text-seduc-neutral-500"
                            >
