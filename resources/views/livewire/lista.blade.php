<div class="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
    @foreach ($escolas as $escola)
        ...
        >
            ...
            <div
                class="mt-2 flex flex-col items-center gap-4 border-t border-white/10 pt-3 font-body text-xs text-white/70"
            >
                <div class="flex flex-col items-center">
                    <strong
                        class="text-[2.25rem] text-glow font-semibold"
                        style="color: rgb(192, 236, 29)"
                        >20</strong
                    >
                    <small class="text-[14px] font-semibold" style="color: rgb(192, 236, 29)"
