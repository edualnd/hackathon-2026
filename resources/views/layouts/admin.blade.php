...
<html lang="pt-BR">
    ...
    <body class="min-h-screen bg-seduc-neutral-100 font-body text-text-on-surface antialiased">
        ...
        <div class="hidden md:flex min-h-screen">
            <aside class="flex w-64 shrink-0 flex-col justify-between bg-base-black px-4 py-6">
                <div>
                    ...
                    <nav class="mt-8 flex flex-col gap-1">
                        ...
                        <x-site.sidebar-link href="#"
                            icon='<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M4 19h16M7 19V9m5 10V5m5 14v-7"/></svg>'>
                            Relatórios
                        </x-site.sidebar-link>
                        <x-site.sidebar-link href="#"
