...
<body
    class="relative min-h-screen bg-fixed bg-gradient-to-br from-background-canvas-primary via-background-canvas-secondary to-background-canvas-tertiary font-body text-text-on-surface antialiased pb-20 sm:pb-0"
>
    ...
    <footer
        class="hidden border-t border-seduc-neutral-200 bg-seduc-neutral-100/60 px-4 py-8 font-body text-xs text-seduc-neutral-600 sm:block"
    >
